    ...
    <View style={styles.container}>
      <View style={styles.sectionA}>
        ...
        <View style={{flex: 1, flexDirection: 'row', alignItems: 'center', paddingLeft: width * 0.09}}>
          <Image 
            ...
            style={{width: 10, height: 10, marginRight: 10, tintColor: '#cc3300'}}
          />
          <Text style={{color: '#777777', fontSize: 10}}>هزینه</Text>
        </View>
      </View>
      ...
      <View style={styles.sectionB}>
        ...
        <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
          ...
          <Text style={{color: '#cc3300', marginLeft: 8, fontSize: 16}}>{toCurrency(props.data.Amount)}</Text>
        </View>
      </View>
