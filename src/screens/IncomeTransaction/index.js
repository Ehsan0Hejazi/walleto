...
import IncomeTransactionHeader from './components/IncomeTransactionHeader';
import Tabs from './components/Tabs';

import { showAddTransaction } from '../../redux/controller/controller.action';

function IncomeTransaction(props) {
  ...
  return (
    <View style={styles.container}>
      <IncomeTransactionHeader navigation={props.navigation} />
      <Tabs />
...
export default connect(mapStateToProps, mapDispatchToProps)(IncomeTransaction);